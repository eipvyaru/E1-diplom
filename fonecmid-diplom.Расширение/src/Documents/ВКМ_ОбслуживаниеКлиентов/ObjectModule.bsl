...
Процедура ОбработкаПроведения(Отказ, Режим)
	...
	Если РеквДогов.ВКМ_ДатаНачалаДоговораОбслуживания <= Дата И РеквДогов.ВКМ_ДатаОкончанияДоговораОбслуживания
	...
	СтоимостьЧаса = РеквДогов.ВКМ_СтоимостьЧасаРаботыСпециалиста;
	...
	Для Каждого ТекСтрокаВКМ_ВыполненныеРаботы Из ВКМ_ВыполненныеРаботы Цикл
		...
		Движение.ВКМ_СуммаКОплате = Движение.ВКМ_ЧасыКОплатеКлиенту * СтоимостьЧаса;
